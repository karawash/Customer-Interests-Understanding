...
import { SliderRail, Handle, Track, Tick } from '../Components/SliderHandler' // example render components - source below
  ...
  Scorefilter = () => {
      ...
      tastegraphA = tastegraphA.filter(function(element){
        if(element.score > min && element.score < max)
          element.activeScore = true
        else
          element.activeScore = false
        return tastegraphA;
      })
